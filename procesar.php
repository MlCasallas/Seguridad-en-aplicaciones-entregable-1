...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verificar si hay algún campo vacío. Si lo hay, se detiene la ejecución y muestra un mensaje de error.
    if (empty($nombre) || empty($email) || empty($password) || empty($fecha_nacimiento) || empty($telefono)) {
